...
export class ProductComponent implements OnInit {
  ...
  constructor() {
    this.storeName = "phone Store";
    this.storeLogo = "https://img.freepik.com/free-vector/bird-colorful-logo-gradient-vector_343694-1365.jpg?w=740&t=st=1706454991~exp=1706455591~hmac=3733404d3bf5c50edeaf7b5108b4c588e3edb2aeeea044750edf62531b018042";
    this.productList = [
